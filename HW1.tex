...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
  \hlkwd{canvas_collatz}\hldef{(}\hlkwd{colorPalette}\hldef{(}\hlsng{"vrolik1"}\hldef{),} \hlkwc{background} \hldef{=} \hlsng{"#dee"}\hldef{,} \hlkwc{n} \hldef{=} \hlnum{100}\hldef{,} \hlkwc{angle.even} \hldef{=} \hlnum{180}\hldef{,} \hlkwc{angle.odd} \hldef{=} \hlnum{0}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
\begin{figure}[H]
...
\end{knitrout}
\label{My Collatz Drawing}
\caption{Messy bunch of thoughts}
\end{center}
\end{figure}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{citation}\hldef{(}\hlsng{"aRtsy"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
