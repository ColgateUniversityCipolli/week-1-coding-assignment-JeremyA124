...
<<CollatzPlot3, eval=FALSE, size="scriptsize", warning=FALSE, message=FALSE>>=
 #?colorPalette
 canvas_collatz(colorPalette("vrolik4"), background = "#dbdbdb", n = 72, angle.odd = -0.05, angle.even = 0.0145)
@
%Code to insert a figure [H]ere
\begin{figure}[H]
\begin{center}
...
<<CollatzPlot4, eval=FALSE, size="scriptsize", warning=FALSE, message=FALSE>>=
  canvas_collatz(colorPalette("vrolik1"), background = "#dee", n = 100, angle.even = 180, angle.odd = 0)
@
\begin{figure}[H]
\begin{center}
<<echo=FALSE,fig.dim=c(4,4)>>=
